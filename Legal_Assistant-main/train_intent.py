...
# --- INJECT GREETING DATA (Class 3) ---
greetings = [
    "hello", "hi", "hey", "good morning", "good evening", "namaste", "sup", "how are you", 
    "who are you", "what is your name", "are you a bot", "thanks", "thank you", "bye", "goodbye"
]
df_greet = pd.DataFrame({'text': greetings * 10, 'intent': [3] * len(greetings) * 10}) # Repeat to balance
df = pd.concat([df, df_greet], ignore_index=True)
